...
* 
  ...
  (제 개발 환경은 3.11.2 버전입니다) (3.11.5 버전을 추천합니다 [https://www.python.org/downloads/release/python-3115/](https://www.python.org/downloads/release/python-3115/))
...
* 
  ...
  (제 개발 환경은 3.11.2 버전입니다) (최신 버전이 아닌 3.11.5 버전을 사용해야 라이브러리 설치가 잘 됩니다 [https://www.python.org/downloads/release/python-3115/](https://www.python.org/downloads/release/python-3115/))
